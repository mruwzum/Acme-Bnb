...
<display:table name="q8" id="row" requestURI="/admin/dashboard.do" pagesize="5"
               class="displaytag">
...
<display:table name="q13" id="row" requestURI="/admin/dashboard.do" pagesize="5"
               class="displaytag">
...
<display:table name="q14" id="row" requestURI="/admin/dashboard.do" pagesize="5"
               class="displaytag">
...
<display:table name="q30" id="row" requestURI="/admin/dashboard.do" pagesize="5"
               class="displaytag">
