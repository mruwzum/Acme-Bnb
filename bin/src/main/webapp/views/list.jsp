...
<display:table pagesize="5" class="displaytag" keepStatus="true" name="tenants" requestURI="${requestURI}" id="row">

	<security:authorize access="permitAll">
		<display:column>
			<a href="tenant/edit.do?tenantId=${row.id}"> <spring:message code="tenant.edit" /> </a>
		</display:column>
	</security:authorize>
